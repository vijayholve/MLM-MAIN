...
const CreateKyc = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("frontAadhar", formData.frontAadhar);
    data.append("backAadhar", formData.backAadhar);
    data.append("frontPan", formData.frontPan);
    data.append("backPan", formData.backPan);
