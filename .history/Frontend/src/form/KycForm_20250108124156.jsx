...
const CreateKyc = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("front_aadhar_img", formData.frontAadhar); // File input names should match the backend field names
    formData.append("back_aadhar_img", formData.backAadhar);
    formData.append("front_pan_img", formData.frontPan);
    formData.append("back_pan_img", formData.backPan);
  ...
  return (
    <>
      <form method="POST" onSubmit={handleSubmit} encType="multipart/form-data" enctype="multipart/form-data">
