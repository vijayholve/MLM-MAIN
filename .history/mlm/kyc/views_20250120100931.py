...
from rest_framework.permissions import cla
    

class View_of_kyc(CreateAPIView): 
    def get(self,request):
        kycs= Kyc.objects.filter(blocked = True)
        serializers= KycSerializer(data= kycs,many=True)
