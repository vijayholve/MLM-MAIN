      ...
      <main className="col-md-9 ms-sm-auto col-lg-9 px-4">
        {user === null ? (
          ...
          <Routes>
            ...
            <Route
              path="/"
              element={<PrivateRoutePage user={user} children={<Home />} />}
            />

            {/* Protected Routes */}
            <Route
              path="/mlm-tree/:mlmId"
              element={<ProtectedPage user={user} children={<MLMTree />} />}
            />
            <Route
              path="/all-users"
              element={<ProtectedPage user={user} children={<MainTable />} />}
            />
            <Route
              path="/create-kyc"
              element={<ProtectedPage user={user} children={<CreateKyc />} />}
            />
          </Routes>
        )}
      </main>
