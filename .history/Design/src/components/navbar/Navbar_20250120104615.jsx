          ...
          >
            <div className="position-sticky py-4 px-3 sidebar-sticky">
              <ul className="nav flex-column h-100">
                ...
                <li className="nav-item">
                  <Nav_link title={"Kyc "} link={"/kyc"} icon={"bi bi-check-circle"} />
                </li>
                <li className="nav-item">
                  <Nav_link
                    title={"Plans"}
                ...
                <li className="nav-item border-top mt-auto pt-2">
                  <Nav_link title={"setting"} link={"/setting"} icon={" bi bi-gear"}/>
                 
                </li>
                <li className="nav-item  mt-auto pt-2">
                  <Nav_link title={"LogOut"} link={"/logout"} icon={" bi bi-gear"}/>
