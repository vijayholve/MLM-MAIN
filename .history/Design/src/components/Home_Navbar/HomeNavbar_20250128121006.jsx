...
const HomeNavbar = () => {
  return (
    <header className="navbar-cont navbar-expand-lg fixed-top header-area header-sticky wow slideInDown" data-wow-duration="0.75s" data-wow-delay="0s">
      <div className="container">
        <div className="row">
          <div className="col-12">
            <nav className="main-nav">
              <a href="index.html" className="logo img-fluid">
                <img src="assets/images/logo-tech.png" className="img-fluid custom-logo" alt="dnd" />
              </a>
