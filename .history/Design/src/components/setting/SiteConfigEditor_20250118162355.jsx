...
const SiteConfigEditor = () => {
    const { siteConfigData, setSiteConfig } = useContext(SiteConfingContent);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`${baseURL}/siteconfig/main/`);, formDataObj, {
    ...
    if (!siteConfigData) return <p>Loading...</p>;
