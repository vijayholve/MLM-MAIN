...
const LoginUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setsubmitblock(true); // Block further submissions while processing
    setopenmessage(false); // Close any previous messages
    ...
    try {
      ...
      setmessage({ success: "", failure: `${err} An unexpected error occurred.`});
      setopenmessage(true);
    } finally {
      setsubmitblock(false); // Allow submissions again
    }
  };
